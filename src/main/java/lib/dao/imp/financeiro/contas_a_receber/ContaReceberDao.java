package lib.dao.imp.financeiro.contas_a_receber;
...
public class ContaReceberDao extends AbstractDao {
    ...
    public List<ContaReceber> getAll(HashMap<String, Object> termos)throws SQLException {
        ...
        while (resultSet.next()){
            ...
            contaPagar.setRecebedor(new ClienteService().getByID(resultSet.getInt("cliente_id")));
...
//    }
    ...
    public ContaReceber getById(Integer id)throws SQLException{
        ...
        if (rs.next()){
            ...
            contaPagar.setRecebedor(new ClienteService().getByID(rs.getInt("fornecedor_id")));
