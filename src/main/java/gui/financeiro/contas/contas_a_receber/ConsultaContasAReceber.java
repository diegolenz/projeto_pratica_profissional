...
import lib.service.ContaReceberService;
 ...
 * @author Diego
 */
public class ConsultaContasAReceber extends SociusTab implements WindowPadrao {

    private List<ContaReceber> contaPagarList;
    private TableModelContas tableModelContas;

    /**
     * Creates new form ConsultaPanel
     */
    public ConsultaContasAReceber(Window parent) {
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new CadastroContaReceberForm(getWindowParent(), true, new ContaReceber()).show();
...
//        try {
//            contaPagar = new ContaReceberService().getById(contaPagarList.get(jTable1.getSelectedRow()).getId());
//        } catch (SQLException ex) {
//            JOptionPane.showMessageDialog(this, "Falha ao retornar dados \n" + ex.getCause() + "\n " + ex.getMessage());
//            return;
//        }
//        CadastroContaReceberForm cadastroContaPagarForm = new CadastroContaReceberForm(getWindowParent(), true, contaPagar);
...
//            return;
//        }
//        ContaReceber contaSelecionada = contaPagarList.get(jTable1.getSelectedRow());
...
//            return;
//        }
//        CadastroContaReceberForm cadastroContaPagarForm = new CadastroContaReceberForm(getWindowParent(), true, contaSelecionada);
//        cadastroContaPagarForm.carregaEdt();
//        cadastroContaPagarForm.bloqueiaEdt();
//        cadastroContaPagarForm.show();
...
//        cadastroContaPagarForm.dispose();
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        try {
            contaPagarList = new ContaReceberService().getAll(termos);
    ...
    private void btnReceberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReceberActionPerformed
        ContaReceber contaPagar = contaPagarList.get(jTable1.getSelectedRow());
        if ( contaPagar == null){
            JOptionPane.showMessageDialog(this, "Selecione um registro");
            return;
        }
        new ReceberContaForm(getWindowParent(), true, contaPagar).show();
