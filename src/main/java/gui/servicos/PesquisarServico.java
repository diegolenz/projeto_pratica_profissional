...
public class PesquisarServico extends DialogPadrao {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisarServico dialog = new PesquisarServico(new javax.swing.JFrame(), true,null);
