...
public class CadastroVendaServicoForm extends DialogPadrao {
     ...
     */
    public CadastroVendaServicoForm(Window parent, boolean modal, VendaProduto venda) {
    ...
    private void initComponents() {
        ...
        edtCliente.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                validaNota(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(edtDtChegada, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void validaNota(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_validaNota
        if (edtNumeroNota.getValue() == null || edtModeloNota.getText() == null || edtModeloNota.getText().isEmpty() || edtNumeroSerie.getValue() == null || venda.getCliente() == null) {
            if (!camposBloquados)
                bloqueia();
            return;
        }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            new VendaProdutoService().save(venda);
