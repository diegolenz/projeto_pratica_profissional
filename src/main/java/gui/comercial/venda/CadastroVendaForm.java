...
public class CadastroVendaForm extends DialogPadrao {
     ...
     */
    public CadastroVendaForm(Window parent, boolean modal, Venda venda) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(edtCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
    ...
    private void validaNota(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_validaNota
        ...
        try {
            if (new VendaService().getByNumSerieModelo(num, modelo, serie, venda.getCliente().getId()) != null) {
                if (edtCodCliente.isEnabled())
                    bloqueia();
                //JOptionPane.showMessageDialog(this, "Código da venda já esta em uso");
            } else if (!edtCodCliente.isEnabled())
                desbloqueia();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroVendaForm dialog = new CadastroVendaForm(new javax.swing.JFrame(), true, new Venda());
